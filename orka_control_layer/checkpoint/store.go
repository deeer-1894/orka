// Package checkpoint implements the runtime checkpoint store binding orka_core's
...
// Store is the control-layer checkpoint contract: the orka_core interface plus
